  ...
  <div id="content-wrapper">
    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Buch löschen</li>
      </ol>


        <!-- Page Content -->
        <h1>Buch wurde erfolgreich gelöscht!</h1>
        <hr>
        ...
        <!-- <style>
          ...
          $sql = "DELETE FROM buecher WHERE ID LIKE '$ID'";
          $result = $conn->query($sql);
          
          echo <<<EOT
          <h4 style=color:red;>Buch-ID: $ID wurde gelöscht</h4><br>
EOT;
          $conn->close();
?>
