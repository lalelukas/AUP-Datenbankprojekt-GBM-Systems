    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <!-- <style>
          ...
          $sql = "UPDATE `buecher` SET `Kunde` = NULL WHERE `buecher`.`ID` = $ID;";
          $result = $conn->query($sql);
          $sql2 = "SELECT * FROM Buecher LEFT JOIN kunden ON buecher.Kunde = kunden.Kundennummer WHERE ID LIKE '$ID'";
          ...
          echo <<<EOT
          <h4 style=color:green;>Folgendes Buch ist nun zurückgegeben: {$row["Titel"]} </h4><br>
          <h5>ID: {$row["ID"]} </h5><br>
