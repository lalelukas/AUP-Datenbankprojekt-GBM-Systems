...
<head>
  ...
  <title>GBM Bücherei - Büchersuche</title>
  ...
  <link href="../../css/buechersuche.css" rel="stylesheet">
  <!-- CSS Input Field -->
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Büchersuche</li>
        </ol>

        <!-- Page Content -->
        <h1>Büchersuche</h1>
        <hr>
        <form action="buecherergebnis.php" method="post">
        ...
        <label>Regal: </label> <input type="text" name="Regal" /><br />
