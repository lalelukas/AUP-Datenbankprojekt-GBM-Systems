...
<head>
  ...
  <title>GBM Bücherei - Kunde suchen</title>
  ...
  <link href="../../css/kundensuche.css" rel="stylesheet">
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <!-- Navbar Search
    <form class="d-none d-md-inline-block form-inline ml-auto mr-0 mr-md-3 my-2 my-md-0" action="kundenergebnis.php" method="post">
      <div class="input-group">

        <input type="text" class="form-control" placeholder="Nach Kunden suchen..." aria-label="Search" aria-describedby="basic-addon2" name="Nachname" /><br />
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Kunde suchen</li>
        </ol>

        <!-- Page Content -->
        <h1>Kunde suchen</h1>
        <hr>
        <form action="kundenergebnis.php" method="post">
        ...
        <input id="submit-btn" type="Submit" value="Suchen" />
        </form>
