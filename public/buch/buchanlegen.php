...
<head>
  ...
  <title>GBM Bücherei - Buch anlegen</title>
  ...
  <link href="../../css/buchanlegen.css" rel="stylesheet">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Buch anlegen</li>
        </ol>

        <!-- Page Content -->
        <h1>Buch anlegen</h1>
        <hr>
        <form action="buchanlegenergebnis.php" method="post">
