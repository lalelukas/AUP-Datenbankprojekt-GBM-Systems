...
<head>
  ...
  <link href="../../css/plaintext.css" rel="stylesheet">
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <hr>
          ...
          $sql = "INSERT INTO `Kunden`(`Vorname`, `Nachname`, `Strasse`, `Hausnummer`, `Postleitzahl`, `Wohnort`, `Mail`)
          VALUES ('$Vorname','$Nachname','$Strasse','$Hausnummer','$Postleitzahl','$Ort','$Mail')";
          
          if ($conn->query($sql) === TRUE) {
              echo "Kunde wurde erfolgreich hinzugefügt";
          } else {
