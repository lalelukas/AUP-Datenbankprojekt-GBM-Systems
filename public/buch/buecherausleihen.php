...
<head>
  ...
  <title>GBM Bücherei - Buch ausleihen</title>
    ...
    <div id="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Buch ausleihen</li>
        </ol>

        <!-- Page Content -->
        <h1>Buch ausleihen</h1>
        <h4>Suche das Buch mit der ID oder ISBN:</h4>
        <hr>
        <form action="buecherausleihenergebnis.php" method="post">
