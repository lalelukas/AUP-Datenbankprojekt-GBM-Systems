...
<head>
  ...
  <title>GBM Bücherei - Ergebnis Büchersuche</title>
  ...
  <ul class="sidebar navbar-nav">
    ...
    <li class="nav-item dropdown show">
        ...
        <div class="dropdown-menu show" aria-labelledby="pagesDropdown" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(5px, 56px, 0px);">
          ...
          <a class="dropdown-item active" href="../../public/buch/buecherausleihen.php">Ausleihen</a>
      ...
      <ol class="breadcrumb">
        ...
        <!-- <style>
          ...
          while($row = $result->fetch_assoc()) {
            if ($row["Kunde"] > 0){
          echo "
          <h4>Folgendes Buch ist bereits ausgeliehen: " . $row["Titel"] . "</h4>
          ...
          <p> <span class=\"fett\">Name:     </span>" . $row["Vorname"] . " " .  $row["Nachname"] . "</p>
          <p> <span class=\"fett\">KundenID: </span>" . $row["Kundennummer"] . "</p>
          ";
            }
            else {
              echo 
              "<h4>Folgendes Buch ist verfügbar: " . $row["Titel"] . "</h4>
              <p> <span class=\"fett\">ID:     </span>" . $row["ID"] . "</p>
              <p> <span class=\"fett\">ISBN:   </span> " . $row["ISBN"] . "</p>
              <p> <span class=\"fett\">Autor:  </span> " . $row["Autor"] . "</p>
              <p> <span class=\"fett\">Regal:  </span> " . $row["Regal"] . "</p><br />";
              echo 
              '<form action="buecherausleihenbest.php" method="post">
              <label class=labelID>Buch-ID: </label> <input type="text" name="ID" value=' . $row["ID"] . ' readonly /> 
              <p class=sameLine> wird von: </p> <br />
              <label class=labelID>Kunden-ID: </label> <input type="text" name="Kunde" /> 
              <p class=sameLine> ausgeliehen. </p> <br />
              <input id="submit-btn" type="Submit" value="Ausleihen bestätigen" />
              </form>';
            }
          }
